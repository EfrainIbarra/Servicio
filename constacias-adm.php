                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>2020670173</td>
                                                <td>https://www.youtube.com/watch?v=BkrICLDQ3T4</td>
                                                <td style="text-align: center;">

                                                    <a class="btn btn-danger btn-sm" onclick="ideEliminar(34);" href="#" data-toggle="modal" data-target="#modal-delete">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    <label style="text-align: right;" for="doc" class="col-sm-3 col-form-label">Documento</label>
                                    <div class="col-sm-9">
